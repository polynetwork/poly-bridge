...
1.以太
```shell script
nft_deploy_tool --chain=2 deployECCD
nft_deploy_tool --chain=2 deployECCM
nft_deploy_tool --chain=2 deployCCMP

nft_deploy_tool --chain=2 transferECCDOwnership
nft_deploy_tool --chain=2 transferECCMOwnership

nft_deploy_tool --chain=2 registerSideChain
nft_deploy_tool --chain=2 approveSideChain

nft_deploy_tool --chain=2 syncSideGenesis
nft_deploy_tool --chain=2 syncPolyGenesis
```
...
nft_deploy_tool --chain=2 deployNFT --name=digitalCat1 --symbol=cat1
nft_deploy_tool --chain=6 deployNFT --name=digitalCat1 --symbol=cat1

nft_deploy_tool --chain=2 bindNFT --asset=0x03d84da9432F7Cb5364A8b99286f97c59f738001 --dstChain=6 --dstAsset=0x03d84da9432F7Cb5364A8b99286f97c59f738001
nft_deploy_tool --chain=6 bindNFT --asset=0x03d84da9432F7Cb5364A8b99286f97c59f738001 --dstChain=2 --dstAsset=0x03d84da9432F7Cb5364A8b99286f97c59f738001
```
