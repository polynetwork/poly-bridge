...
var ETH_CHAINS = []uint64{
	...
	SEPOLIA_CROSSCHAIN_ID, OASIS_CROSSCHAIN_ID, HARMONY_CROSSCHAIN_ID, KCC_CROSSCHAIN_ID, BYTOM_CROSSCHAIN_ID, HSC_CROSSCHAIN_ID,
	...
	CLOUDTX_CROSSCHAIN_ID, NAUTILUS_CROSSCHAIN_ID,
}
