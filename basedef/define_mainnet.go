...
const (
	...
	BYTOM_CROSSCHAIN_ID       = uint64(100000701)
	KCC_CROSSCHAIN_ID         = uint64(1000900)
	ONTEVM_CROSSCHAIN_ID      = uint64(1000333)
	MILKOMEDA_CROSSCHAIN_ID   = uint64(100810)
	KAVA_CROSSCHAIN_ID        = uint64(10000088)
	CUBE_CROSSCHAIN_ID        = uint64(10000099)
...
var ETH_CHAINS = []uint64{
	...
	OASIS_CROSSCHAIN_ID, KCC_CROSSCHAIN_ID, ONTEVM_CROSSCHAIN_ID, MILKOMEDA_CROSSCHAIN_ID, KAVA_CROSSCHAIN_ID, CUBE_CROSSCHAIN_ID,
}
