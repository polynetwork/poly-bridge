...
const (
	...
	NAUTILUS_CROSSCHAIN_ID    = uint64(1060)
...
var ETH_CHAINS = []uint64{
	...
	SEPOLIA_CROSSCHAIN_ID, OASIS_CROSSCHAIN_ID, HARMONY_CROSSCHAIN_ID, KCC_CROSSCHAIN_ID, HSC_CROSSCHAIN_ID, ONTEVM_CROSSCHAIN_ID,
	...
	BRISE_CROSSCHAIN_ID, DEXIT_CROSSCHAIN_ID, CLOUDTX_CROSSCHAIN_ID, XINFIN_CROSSCHAIN_ID, NAUTILUS_CROSSCHAIN_ID,
}
