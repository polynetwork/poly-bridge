...
func NewHealthMonitorHandle(monitorConfig *conf.HealthMonitorConfig) MonitorHandle {
	...
	case basedef.ETHEREUM_CROSSCHAIN_ID, basedef.O3_CROSSCHAIN_ID, basedef.BSC_CROSSCHAIN_ID, basedef.PLT_CROSSCHAIN_ID,
		...
		basedef.ASTAR_CROSSCHAIN_ID, basedef.GOERLI_CROSSCHAIN_ID, basedef.BRISE_CROSSCHAIN_ID, basedef.DEXIT_CROSSCHAIN_ID,
		basedef.CLOUDTX_CROSSCHAIN_ID, basedef.SEPOLIA_CROSSCHAIN_ID, basedef.XINFIN_CROSSCHAIN_ID, basedef.NAUTILUS_CROSSCHAIN_ID,
		basedef.GOSHEN_CROSSCHAIN_ID, basedef.CRONOS_CROSSCHAIN_ID, basedef.OKB_CROSSCHAIN_ID:
