...
func (this *EthereumChainListenBatch) HandleNewBlockBatch(startHeight uint64, endHeight uint64) ([]*models.WrapperTransaction, []*models.SrcTransaction, []*models.PolyTransaction, []*models.DstTransaction, error) {
...
func (this *EthereumChainListenBatch) getWrapperEventByBlockNumber(contractAddr string, startHeight uint64, endHeight uint64) ([]*models.WrapperTransaction, error) {
