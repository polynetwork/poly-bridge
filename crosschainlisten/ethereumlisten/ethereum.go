...
func (this *EthereumChainListen) getSwapEventByBlockNumber(contractAddr string, startHeight uint64, endHeight uint64) ([]*models.ProxyLockEvent, []*models.SwapEvent, error) {
	if len(contractAddr) == 0 {
		return nil, nil, nil
	}
