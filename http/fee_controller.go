...
func (c *FeeController) GetFee() {
	...
	if getFeeReq.SwapTokenHash != "" {
		...
		if tokenMap.DstChainId != basedef.PLT_CROSSCHAIN_ID && tokenMap.DstChainId != basedef.PLT2_CROSSCHAIN_ID && tokenMap.DstChainId != basedef.BCSPALETTE_CROSSCHAIN_ID && tokenMap.DstChainId != basedef.BCSPALETTE2_CROSSCHAIN_ID && tokenMap.DstChainId != basedef.APTOS_CROSSCHAIN_ID {
