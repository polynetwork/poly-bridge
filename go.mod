...
require (
	...
	github.com/portto/aptos-go-sdk v0.0.0-20221013094043-bdfe9143d619
...
replace (
	...
	github.com/portto/aptos-go-sdk => github.com/wuyachi/aptos-go-sdk v0.0.0-20221017093939-be802d7b7fd1
